...
output_window_size="128"
        ...
        # ],
(
    working_dir="/mnt/wd500GB/CSC500/csc500-super-repo/datasets/automated_windower/windowed_EachDevice-200k_batch-100_stride-5_distances-2/"
    mkdir -p $working_dir &&
...
(
    working_dir="/mnt/wd500GB/CSC500/csc500-super-repo/datasets/automated_windower/windowed_EachDevice-200k_batch-100_stride-10_distances-2/"
    mkdir -p $working_dir &&
    cd $shuffler_dir_path &&
    # cat << EOF
    cat << EOF | ./windowed_dataset_shuffler.py -
