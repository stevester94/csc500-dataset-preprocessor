...
output_window_size="128"
        ...
        # ],
# (
#     working_dir="/mnt/wd500GB/CSC500/csc500-super-repo/datasets/automated_windower/windowed_EachDevice-200k_batch-100_stride-20_distances-2/"
#     mkdir -p $working_dir &&
...
# (
#     working_dir="/mnt/wd500GB/CSC500/csc500-super-repo/datasets/automated_windower/windowed_EachDevice-200k_batch-100_stride-20_distances-2.8.14.20.26.32.38.44.50.56.62/"
#     mkdir -p $working_dir &&
#     cd $shuffler_dir_path &&
#     # cat << EOF
#     cat << EOF | ./windowed_dataset_shuffler.py -
...
# (
#     working_dir="/mnt/wd500GB/CSC500/csc500-super-repo/datasets/automated_windower/windowed_EachDevice-200k_batch-100_stride-20_distances-2.8/"
#     mkdir -p $working_dir &&
#     cd $shuffler_dir_path &&
#     # cat << EOF
#     cat << EOF | ./windowed_dataset_shuffler.py -
...
(
    working_dir="/mnt/wd500GB/CSC500/csc500-super-repo/datasets/automated_windower/windowed_EachDevice-200k_batch-100_stride-20_distances-2.8.14.20.26.32/"
